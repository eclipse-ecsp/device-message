...
`eclipse-ecsp/device-message` up to date and always improving! There are a few guidelines that we need
...
1. Please make sure there is no [open issue](https://github.com/eclipse-ecsp/device-message/issues) yet.
...
- Submit a pull request from your topic branch to the [main](https://github.com/eclipse-ecsp/device-message) branch on the `eclipse-ecsp/device-message` repository.
...
- Ensure that the PR is tagged with related [issue](https://github.com/eclipse-ecsp/device-message/issues) it intends to resolve.
